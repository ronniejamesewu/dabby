...
| Rig 3 (sapphire insert — Dr. Dabber Sapphire Plus v2) | Run 8 (420°F): ultra-clean swab, very strong delayed effect, harshness 11s into the hold. Run 9 (415°F, small load): clean first draw, wispy vapor, trace harshness only as load ran out — load-size confound. Run 10 (415°F, ~25% larger load): no harshness across two full draws — load-size confound resolved. 415°F confirmed clean on the sapphire. Slightly more reclaim at 415°F vs. 420°F; medium effect vs. Run 8's very intense, suggesting 415°F sits at the lower edge of the useful band. | OC Runs 8–10 (May 22–23, 2026) — three data points | Low-Moderate — three runs, one strain, still early empirical calibration | Empirical calibration from scratch. Do not scale from quartz curves. 420°F produced harshness; 415°F confirmed clean. Walking up incrementally toward harshness threshold — next test 417°F. |
