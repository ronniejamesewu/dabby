...
| Ramp-to-460°F experiment on Rig 5 is closed | FW106 R11-12 (June 5, 2026): device accepted programmed 460°F endpoint at 40s but sapphire thermal mass prevented reaching it — estimated actual peak high 440s. Both runs confirmed above ceiling (toasty taste, harsh 2nd draw). Two findings settled: (1) Rig 5 cannot reach 460°F in a 40s session; (2) the high 440s it does reach is above FW106's clean zone. No further 460°F experiments on Rig 5 without a longer session or a different insert. | Session 93 |
