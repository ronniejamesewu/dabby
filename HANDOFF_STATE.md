...
*Last generated: May 25, 2026 at 2:13 PM MDT*

---

## Summary
- **Total runs:** 49 across 12 strains
...
### Watermellos
**1 session** &nbsp;·&nbsp; Last: May 25, 2026 &nbsp;·&nbsp; Equipment: Rig 4 — Dr. Dabber Sapphire Plus (v2) · Cloud Vortex 21.0 · 5mm synthetic ruby pearl · Dr. Dabber stock bubbler

**Next:** Limit draws on Run 2 — confirm draw count as harshness driver

**Dab Notes:** I totally did more draws than I should have and felt the harshness afterward. Throat is sore 10 minutes later. Swabs were clean, more on the golden side than we've been seeing but nothing dark. Effects is pretty intense. Van Halen sounds amazing.

**AI Analysis:** Post-session soreness with minimal in-session harshness is a different pattern from FW106 R2, but draw count is still the likeliest variable. Run 2: limit to 1–2 draws at the same baseline curve and endpoint. If the post-session soreness drops meaningfully, draw count is the driver. If it persists on a controlled draw count, drop the endpoint. The golden swab is worth watching — if it's consistent on Run 2 with the same curve, it's Watermellos' baseline character on Rig 4, not a temperature signal.
