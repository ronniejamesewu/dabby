...
*Last generated: May 21, 2026 at 11:18 PM MDT*

---

## Summary
- **Total runs:** 40 across 10 strains
- **Active since:** May 2, 2026 (20 days)
- **Last run date:** May 21, 2026
...
### WW Z
**8 sessions** &nbsp;·&nbsp; Last: May 21, 2026 &nbsp;·&nbsp; Equipment: Cloud Vortex 21.0, 6mm pearl

**Next:** Run 9: one small load remains — same fast ramp to 420°F, spinner config (second chunk went to Sarah, unlogged)

**Dab Notes:** Run 8 (small load, spinner): light golden swab — same as Gemlock. First 30s smooth, second 20s rising harshness — more harsh than Run 7 (normal load, Gemlock). Medium intensity, slow onset, ~2.5–3h duration. Second chunk: Sarah, unlogged.

**AI Analysis:** Two small loads remain on spinner. Run 8's harshness result runs opposite to Runs 5–6 (small load clean, normal load harsh on Gemlock) — but equipment changed at the same time, so it doesn't settle the contradiction. Runs 9 and 10: same small loads, same curve, same spinner config — continue and document. If harshness stays elevated across both, the spinner becomes the more likely driver than load size. After the last chunk, that's the primary open question.

**Proposed Curve:**
- 0s → 380°F — Session open
- 10s → 400°F — Fast early climb
- 20s → 420°F — Endpoint — 420°F in 20s, 2°F/sec
- 50s → 420°F — Hold
