...
*Last generated: May 21, 2026 at 11:09 PM MDT*
...
**Next:** Runs 9–10: two small loads remain — same fast ramp to 420°F, spinner config

**Dab Notes:** Run 8 (small load, spinner): light golden swab — same as Gemlock. First 30s smooth, second 20s rising harshness — more harsh than Run 7 (normal load, Gemlock). Medium intensity, slow onset.
