...
*Last generated: May 19, 2026 at 10:34 AM MDT*

---

## Summary
- **Total runs:** 34 across 10 strains
- **Active since:** May 2, 2026 (17 days)
- **Last run date:** May 18, 2026
...
### WW Z
**2 sessions** &nbsp;·&nbsp; Last: May 18, 2026 &nbsp;·&nbsp; Equipment: Gemlock joystick, no pearl

**Next:** Repeat Run 2 curve — harshness appeared, needs confirmation

**Dab Notes:** Nothing recorded

**AI Analysis:** Equipment and curve both changed from Run 1, so harshness can't be attributed to either variable yet. Repeat the same fast-ramp curve (375→400→420, 60s) on Run 3. If harshness shows up again it's real; if it doesn't, Run 2 may have been noise or a bad load day. Swab is clean and intensity is strong — no floor signal, no reason to touch the endpoint. If harshness reproduces, pay attention to where in the session it lands.

**Proposed Curve:**
- 0s → 375°F — Session open
- 15s → 400°F — Faster mid climb
- 30s → 420°F — Endpoint — fast ramp, down 20°F from Run 1
- 60s → 420°F — Hold
