...
*Last generated: May 20, 2026 at 9:47 PM MDT*

---

## Summary
- **Total runs:** 38 across 10 strains
...
### WW Z
**6 sessions** &nbsp;·&nbsp; Last: May 20, 2026 &nbsp;·&nbsp; Equipment: Gemlock joystick, no pearl

**Next:** Run 7: drop to 420°F endpoint, full load — test whether harshness clears at lower temperature

**Dab Notes:** Run 6 (same curve, fuller load): light golden swab, tail harshness, hit really hard. Load size confirmed directionally to influence both harshness and effect strength.

**AI Analysis:** Load-size influence is confirmed directionally — same curve, fuller load, harshness returned; lighter load, harshness absent. The next test is whether dropping the endpoint resolves it: try 420°F endpoint, same fast ramp shape, full load. That isolates temperature from load size. If harshness clears at 420°F with a full load, the ceiling is somewhere between 420-430°F. If it doesn't, the curve shape itself needs rethinking.

**Proposed Curve:**
- 0s → 380°F — Session open
- 15s → 410°F — Steeper mid climb
- 30s → 420°F — Endpoint — down 10°F from Runs 3-6
- 50s → 420°F — Hold
