...
*Last generated: May 25, 2026 at 4:21 PM MDT*

---

## Summary
- **Total runs:** 51 across 12 strains
...
### Watermellos
**3 sessions** &nbsp;·&nbsp; Last: May 25, 2026 &nbsp;·&nbsp; Equipment: Rig 5 — Dr. Dabber Sapphire Plus (v2) · Cloud Vortex 21.0 · 5mm synthetic ruby pearl + 5mm synthetic ruby pearl · Dr. Dabber stock bubbler

**Next:** Run 4: add draws on Rig 5 at baseline — find the draw-count harshness threshold

**Dab Notes:** Ultra clean beige swabs, no harshness across two big draws. Immediate big effect. If anything maybe faster climb and 5-10 seconds shorter

**AI Analysis:** Two consecutive clean runs at 2 draws on Rig 5 make draw count the leading candidate for Run 1's harshness. Run 4: stay on Rig 5, same baseline curve, add draws — find where harshness re-enters with rig held constant. If it comes back at 3+, draw count is confirmed. If it stays clean, the ceiling is higher than 2. Faster/shorter curve idea noted for after the draw-count question is settled.
