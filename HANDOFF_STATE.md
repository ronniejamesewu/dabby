...
*Last generated: May 17, 2026 at 7:49 PM MDT*

---

## Summary
- **Total runs:** 32 across 10 strains
...
**5 sessions** &nbsp;·&nbsp; Last: May 17, 2026 &nbsp;·&nbsp; Equipment: Gemlock joystick, no pearl

**Next:** Last dab in jar — try faster ramp to 415°F, shorter session (50s total)

**Dab Notes:** Run 5 at 415°F (same curve as Run 4): super light golden swab, lighter than Run 4. Tiny bit of harshness in the throat. Tiny bit of burnt taste at the very last draw. Pretty hard hit. Only one dab left in the jar.

**AI Analysis:** Tail harshness confirmed at 415°F across Runs 4 and 5. The burnt taste at the very last draw on Run 5 points specifically at the session tail as the problem zone. Last dab tries a different angle: reach 415 faster (30s vs. 45s), cut total to 50s — testing duration-at-temperature rather than temperature itself. One data point; treat it accordingly.

**Proposed Curve:**
- 0s → 375°F — Session open
- 15s → 400°F — Faster mid climb
- 30s → 415°F — Endpoint — faster ramp
- 50s → 415°F — Hold — shorter session
