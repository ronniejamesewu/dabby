...
*Last generated: May 24, 2026 at 8:37 PM MDT*

---

## Summary
- **Total runs:** 47 across 11 strains
...
**Next:** Repeat baseline curve — confirm Run 1 results

**Dab Notes:** Swabs are super clean, very light beige. Harshness very mild and at roughly 11 seconds left mark. Very flavorful, terpenes obvious from the coughing without harshness.

**AI Analysis:** Clean first run, strong terpene expression. Repeat the baseline on Run 2 before changing anything — confirm whether harshness timing and flavor character are consistent. If Run 2 comes back similar, 416°F is in the right neighborhood. If harshness is meaningfully later or absent, the ruby pearl may be behaving slightly differently than the quartz; worth tracking.
