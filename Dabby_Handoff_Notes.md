...
**Fembot #3** (Riptide, CO — Fuzzy Melon × Rambutan, cold cure, 169–73 micron) — In calibration. Run 1 (May 9, 2026): 380→390→410→430°F ramp, 65s. Light golden swab, clean. Tasty on ascent, slight harshness at tail. Nice upbeat creative effects. Run 2 pending: steady 420°F flat hold, 60s.
...
- Fembot #3 Run 2 pending — steady 420°F flat hold, 60s. Run 1 had slight harshness at tail at 430°F.
...
- **May 9, 2026 — Session 12:** Fembot #3 Run 1 logged (May 9, 2026). Curve: 380→390→410→430°F ramp, 65s. Light golden swab, clean. Tasty on ascent, slight harshness at tail, nice upbeat creative effects. Run 2: steady 420°F flat hold, 60s. Dashboard medal logic updated to award 🥇 to all strains tied for first place (previously only the first sorted strain).
