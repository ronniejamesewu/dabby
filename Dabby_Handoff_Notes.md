...
- **May 10, 2026 — Session 14:** Orange Candy Run 7 logged (May 10, 2026). 430°F steady flat hold, 69s — plain amber swab, pleasant, not as tasty as ramp, harsh in last 20 seconds. Ramp (Run 6) outperforming flat hold at same 430°F endpoint — consistent with Fembot #3 pattern. Next: repeat Run 6 ramp to confirm, or try 420°F flat hold.
