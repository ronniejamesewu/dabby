...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Blueberry 36 #2",                  profile_anchor="#bb362-profile",    next_text="Run 5: minimal load at 416°F — hold result loosely given jar variability", accent=None, slug="bb362",
        info=BB36_2_INFO,
