...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Watermellos", profile_anchor="#watermellos-profile", next_text="Run 13: fast 8s ramp to 420°F, 2 draws only (no second cycle) — isolate swab shift from extended session heat", accent=None, slug="watermellos",
        ...
        next_dab_notes="Hit it same as yesterday, 2x2. First draw had the mildew, second had a little hint of watermelon! Harshness peeked through at the very end. Third and fourth were tasty, a tiny bit harsh in throat, toasted by end of 4th. Heavy effect pretty fast. Swabs dark gold.",
        next_ai_analysis="Two consecutive dark gold swabs on 2x2 sessions (Runs 11–12) — the streak is real, cause still unresolved. Run 13: 2 draws only, no second cycle. If swab comes back to beige, extended heat was driving both dark gold reads. If it stays dark gold on 2 draws, the material quality shift read has strong support across three runs.",
        next_waypoints=FW106_FASTER_420,
    ),
]
