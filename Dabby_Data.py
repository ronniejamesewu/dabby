...
COMPLETED_RUNS = [
    ...
    CompletedRun(strain="Fire Water #106", run_date=date(2026, 6, 12), sessions_prior_today=1, utc_logged_at=datetime(2026, 6, 13, 3, 30, tzinfo=timezone.utc), equipment=RIG_5, waypoints=FW106_FASTER_420_60S,
        duration_seconds=60, endpoint_note='<strong>Endpoint:</strong> 420°F — 8s ramp; 60s hold &nbsp;|&nbsp; <strong>Note:</strong> Rig 5; same curve as Run 16 (Rig 4)',
        swab="Dark golden.",
        intensity="High",
...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Fire Water #106", profile_anchor="#fw106-profile", next_text="Run 18: repeat 8s ramp to 420°F, 60s hold on Rig 5 — watch within-draw vapor pattern (thick-to-wispy vs. Run 16 on Rig 4?)", accent=None, slug="fw106",
        info=FW106_INFO,
