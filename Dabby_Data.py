...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Blueberry 36 #2",                  profile_anchor="#bb362-profile",    next_text="Try minimal load at 416°F on Run 5 — Run 4 already loaded large; go as light as the gooey consistency allows", accent=None, slug="bb362",
        ...
        next_dab_notes="Swabs were clean and dark gold. 3 draws, very tasty, a little bit of harshness started in end of draw 2. Stayed low level. Medium intensity. Incredible quality and taste — easily as good as any top tier rosin I've had, maybe better.",
