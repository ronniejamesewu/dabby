...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Fire Water #106", profile_anchor="#fw106-profile", next_text="Run 16: normal load, 420°F 8s ramp — isolate load variable", accent=None, slug="fw106",
        info=FW106_INFO,
        ...
        next_dab_notes="Beige swabs, lots of reclaim. Tiny hint of harshness around 7 seconds left, very minor — ran a second heating cycle and had two more draws. Still got a lot of reclaim after second cycle. Really tasty. Very very intense, uplifting, euphoric. Load was bigger than normal — consistency made it hard to load a normal amount.",
