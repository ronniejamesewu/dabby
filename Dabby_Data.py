...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Orange Candy", profile_anchor="#oc-profile", next_text="Run 14: repeat 416°F on Rig 5 — confirm wispy vapor pattern and intensity; or Rig 3 repeat to isolate rig variable", accent=None, slug="oc",
        info=OC_INFO,
        ...
        next_dab_notes="Dark golden swabs, noticeably darker than what we've been smoking but not at all into brown. First short draw and I got an interesting orange peel note, closest I've had to any flavor that would match the name. Vapor was wispy through the whole session, so much so that I ran a second cycle when it ended, and that cycle produced denser vapor but a taste that it was getting toasty. That explains the darker swabs. But I got very very very stoned. Not much else going on flavor wise, I believe this was an older jar when I got it.",
        next_ai_analysis="First OC run on Rig 5 — intensity was emphatically higher than 415°F (very very very stoned, first dab of the day), but the rig switch is a confound. Wispy vapor throughout and material left at 50s are consistent with Rig 5's BB36#2 pattern. Dark golden swabs explained by the toasty second cycle, not a first-cycle floor signal. Repeat 416°F on Rig 5 to confirm whether wispy vapor and intensity hold. If intensity stays very high and vapor stays wispy, the rig is the vapor-density variable — not the endpoint — and a higher ramp or longer hold may be needed for OC on Rig 5.",
