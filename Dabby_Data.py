...
COMPLETED_RUNS = [
    ...
    CompletedRun(strain="Fire Water #106", run_date=date(2026, 5, 25), sessions_prior_today=0, utc_logged_at=datetime(2026, 5, 25, 23, 30, tzinfo=timezone.utc), equipment=RIG_4, waypoints=BASELINE_CURVE,
...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Fire Water #106", profile_anchor="#fw106-profile", next_text="Repeat baseline curve — confirm Run 1 results", accent=None, slug="fw106",
        info=FW106_INFO,
        ...
        next_dab_notes="Swabs are super clean, very light beige. Harshness very mild and at roughly 11 seconds left mark. Very flavorful, terpenes obvious from the coughing without harshness.",
        next_ai_analysis="Clean first run, strong terpene expression. Repeat the baseline on Run 2 before changing anything — confirm whether harshness timing and flavor character are consistent. If Run 2 comes back similar, 416°F is in the right neighborhood. If harshness is meaningfully later or absent, the ruby pearl may be behaving slightly differently than the quartz; worth tracking.",
