...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Fire Water #106", profile_anchor="#fw106-profile", next_text="Try 1–2 draws at 416°F — isolate draw-count vs. temperature as harshness driver", accent=None, slug="fw106",
        ...
        next_dab_notes="Same ultra clean light beige. Harshness again very mild, around 25 seconds left. Grew through second and third draws. Third draw it was almost unbearable harshness. Pretty big intensity right now.",
