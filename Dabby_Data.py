...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Blueberry 36 #2",                  profile_anchor="#bb362-profile",    next_text="Repeat baseline curve on Run 2 — watch wispiness and swab before adjusting", accent=None, slug="bb362",
        info=BB36_2_INFO,
        ...
        next_dab_notes="Very golden swabs, I remember this jar seemed to have darker reclaim than its sisters. But generally clean looking, just a tad dark. Two big draws and then a 6 second third. No harshness at all, terp cough though. First draw was really flavorful, lots of fruit but I couldn't pick one out. Second draw less flavorful but not at all unpleasant. Very wispy vapor, wonder if this wants more heat applied. Effects are starting light, some body sensation. I think this one builds over maybe 15 mins. Oh I get a very clear blueberry note much much after taking the dab. It seems to come up my throat too, which is a strange way for something to show up. Moderate intensity — creative and chatty energy, body tingling movement sensations, nothing overpowering.",
        next_ai_analysis="Clean first run at 416°F — no harshness, moderate intensity, within-range swab. Wispy vapor and the golden swab are two threads that could point toward a too-low endpoint, but they're also consistent with the jar's inherent character and load size. One run is not enough to adjust from. Repeat the baseline on Run 2 to confirm. If Run 2 is also wispy with the same golden swab and intensity stays moderate or below, bump to 420°F on Run 3 — same ramp shape, +4°F. Don't carry BB36 #1's harshness history at 415°F as a reason for caution here: all of #1's data is Rig 2 (Gemlock, no pearl), a cooler pathway, and this is a different phenotype on a different rig. The operating context doesn't transfer.",
