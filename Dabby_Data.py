...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Fire Water #106", profile_anchor="#fw106-profile", next_text="Run 15: 8s ramp to 420°F, normal load — vapor density vs. throat-heat test", accent=None, slug="fw106",
        ...
        next_ai_analysis="420°F isn't confirmed clean independent of load — Run 14's tail harshness came with material remaining and only 2 draws, which depletion can't explain. Run 15: repeat the 8s ramp to 420°F, 2 draws, with a deliberately normal/light load. This now does double duty: if a lighter load runs clean to the tail, vapor density was driving it and 420°F is the operating point; if tail harshness persists at the same curve and duration, that supports the throat-heat-accumulation read (load-independent thermal dose) and points the lever at a shorter session or lower endpoint rather than load.",
