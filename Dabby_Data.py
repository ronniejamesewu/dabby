...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Watermellos", profile_anchor="#watermellos-profile", next_text="Run 12: fast 8s ramp to 420°F, 2 draws only (no second cycle) — isolate swab shift from extended session heat", accent=None, slug="watermellos",
        ...
        next_dab_notes="Dark golden swabs, ran it two cycles two draws each. Harshness at end of draw 2 and throughout draws 3 and 4. Pretty mild. More than anything I think it points to substandard quality of the rosin. Hit really hard.",
        next_ai_analysis="Run 11 introduced a swab shift — dark golden where WM has been consistently beige on Rig 5 across Runs 2–10. Run 12: same fast ramp to 420°F, 2 draws only, no second cycle. If swab comes back to beige at 2 draws, the dark golden on Run 11 was extended-session-heat driven (the second cycle kept the insert hot longer). If it stays dark golden on 2 draws, the user's quality-shift read has more support and the material itself is likely changing as the jar ages.",
        next_waypoints=FW106_FASTER_420,
    ),
]
