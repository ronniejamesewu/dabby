...
STRAIN_STATUS = [
    ...
    StrainStatus(name="Watermellos", profile_anchor="#watermellos-profile", next_text="Run 11: fast 8s ramp to 420°F, 2-draw limit — confirm operating point and flavor character", accent=None, slug="watermellos",
        ...
        next_dab_notes="First draw to about 21 seconds left. Almost no vapor. Tasted the mildewy taste. Second draw was only about 5 seconds and then I tasted some pine sol and coughed. So third draw finished it. In third draw I tasted some toasted flavors. I had sense there was more so I reran the cycle and did indeed get a nice two more draws that were somehow less toasted and less harsh. What! Beige swabs, intense high. No post-session throat soreness.",
        next_ai_analysis="Repeat the fast 8s ramp to 420°F with a deliberate 2-draw limit. The toasted draw 3 follows the established Rig 5 depletion ceiling — cutting at 2 draws removes it. Two draws also gives the cleanest read on whether the wispy opening and the mildewy/pine sol flavor character are consistent WM traits at this setup. If it comes in clean at 2 draws, the fast ramp at 420°F is confirmed as the operating point.",
        next_waypoints=FW106_FASTER_420,
    ),
]
