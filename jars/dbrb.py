...
RUNS = [
    CompletedRun(
        ...
        swab='golden',
        session_char='Golden swab, minimal reclaim; full first cycle plus one draw of a second, ended on satiety rather than harshness; heavy terp coughing on draw 1; mild harshness at end of cycle 1, second cycle clean; both strains present on draw 1 — garlic-cheese and lemon-pledge/lime; big intensity, still climbing post-session (dizziness reported well after session end)',
        intensity='big',
        dab_notes='Definitely a garlic funk cold nose. Not getting a lot of fruit but it\'s still cold from the fridge. [Post-dab:] Godamn that was great. [Report:] I succeeded in getting both strains. So there was this garlicky cheesy note, and then there was also this lemon pledge note. Maybe a squeeze of lime. But tasting all that was in between coughing really hard on the terps. I kind of wonder if the terps are the thing causing harshness. It was mild, not sure when it showed up even, because of the coughing, but it was there at the end. I took a thirty second break and ran second cycle. Took a good hit, still tasty, but at that point I\'d had enough. I terminated the cycle. Sean\'s were golden, minimal reclaim. Intensity is big, let\'s see how heavy it gets. [Clarified: harshness was end of first cycle, second cycle clean as far as could tell; load normalish, maybe a tad bigger; "Sean\'s" logged as "swabs".] [Later, post-logging:] Whoa fuck dizzy.',
