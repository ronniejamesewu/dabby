...
STATUS = StrainStatus(
    ...
    next_text='Run 10: rerun Run 9\'s exact 440°F bounded-hold descent on Rig 8, first dab, deliberately modest load — the load isolation, a second no-harshness read, and a second look at the new top in one run',
    accent=None,
    slug='lhbh',
    info=[
