...
STATUS = StrainStatus(
    ...
    next_text='Run 15 — grey 450°F, modest load, single cycle, first dab: rerun the clean R9/R11 conditions to see whether R14\'s chest tracks the bigger load or the dirtier insert.',
    accent=None,
    slug='sourtangie',
    info=[
