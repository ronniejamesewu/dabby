...
STATUS = StrainStatus(
    ...
    next_text='Run 15: same gentle descent, try proactive water mid-session — two consecutive runs (R13, R14) have now shown post-session heartburn-like chest/throat discomfort; test whether water changes that',
    accent=None,
    slug='hive1',
    info=[
