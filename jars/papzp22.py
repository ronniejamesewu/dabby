...
RUNS = [
    ...
    CompletedRun(
        ...
        session_char="Two-curve session, 3rd dab of the day, normal load. Cycle 1 on the grey 450°F bounded-hold descent: mild bottom-of-throat harshness after the cycle, heavy terpene-load coughing that cut draws short, big flavor, and 'maybe a hint of toast' in the first draw. Cycle 2 switched to the teal 430°F bounded-hold descent — no reason stated for the switch; 'Really good! That was the answer!' — with no toast mentioned on cycle 2. Terminated with ~14s left: 'seemed wispy' and the user had had enough. Chest not asked and not reported either way; harshness location given as throat. Swab beige with a localized dark-gold spot (user suspects pooled reclaim outside the joystick airflow). Pretty hard.",
        intensity="pretty hard",
        dab_notes="[Pre-dab:] Doing it, and normal load. [Cycle 1, grey 450:] Mild harshness at bottom of throat after first cycle. Tons of terp coughing, a lot of flavor and maybe a hint of toast in the first draw. It occurred to me to try 445 or 440. The coughing caused me to not get a lot of draws, so I'm gonna see about a second cycle. [Switching to the teal 430 curve for second cycle.] [Cycle 2:] Really good! That was the answer! Terminated with 14 seconds left, seemed wispy and I'd had enough. [Swab / insert:] Beige with a little bit of dark gold. I suspect it's from a place where reclaim pooled and didn't get hit with air from the joystick to vaporize. It hit pretty hard. I swab the insert after every dab and I deep clean everything once a week or less. Last time I deep cleaned was Tuesday evening.",
        analysis="Run 9 ran two curves in one session: 3rd dab of the day, normal load, cycle 1 on the grey 450°F bounded-hold descent, then cycle 2 switched to the teal 430°F bounded-hold descent. The user gave no reason for the switch — comfort after the throat harshness and heavy coughing is as plausible as chasing the toast question, and the within-session-A/B framing came from the AI side of the conversation, not the user. The toast observation itself was doubly hedged — 'maybe a hint of toast in the first draw' — and cycle 2 drew no toast mention at all; 'Really good! That was the answer!' is the user's entire cycle-2 read, and it was never explicitly tied to the toast. Read at that weight: one hedged toast note at a 450°F open on fresh material, none mentioned at a 430°F open on the same load's remainder — consistent with the cooler open, with residue burning off during cycle 1, and with a 'maybe' that was never there; cycle order and partially-spent material confound the comparison regardless. The user suggested trying 445 or 440 ('it occurred to me') — captured at suggestion weight. Insert state: deep-cleaned Tuesday evening (two days prior), swabbed after every dab; the user's suspicion for the dark-gold swab spot is reclaim pooled where the joystick airflow doesn't reach — a localized pooled-reclaim pocket is the residue candidate, not a generally dirty insert. A clean-insert rerun at 450°F is the cheap way to close the question.\n\nMild bottom-of-throat harshness after cycle 1 — the within-day mucosal climb Sour Tangie showed across same-day dabs (R11→R13), landing on the 3rd dab where the cumulative-exposure framing expects it. Chest was not asked and not reported either way this run — the stated location was throat, and the post-session window (where Sour Tangie R14's chest arrived) wasn't checked; no chest claim in either direction is on record.\n\nHeavy terpene-load coughing off the 450°F open cut the draws short — the dense peak bolus again (Run 8's sinus 'terp shudders'; the terpene-cough this log holds separate from harshness) — likely leaving more material for the second cycle. The session ended with ~14s left in cycle 2 on 'seemed wispy' and having had enough — a satiety stop with a wispy-vapor read consistent with depletion; not a harshness stop, though the mild cycle-1 throat harshness means harshness wasn't absent this session, just not limiting.\n\nSwab beige with the dark-gold spot — mostly the clean range; the spot, if the user's pooled-reclaim suspicion is right, is consistent with airflow-gated vaporization (material outside the directed airflow degrading in place, the FW106 R31 mechanism), at suggestion weight. Two-cycle run, within-strain only — not a floor signal. Intensity 'pretty hard,' up from Run 8's moderate — normal load (vs. Run 8's planned-modest, never restated by the user), 3rd-dab order, and two cycles all differ; not isolable.",
    ),
]
...
STATUS = StrainStatus(
    ...
    next_text='Run 10: deep-clean the insert, then rerun the grey 450°F descent (450→450@10s→425@30s→410@45s) as a first-dab, modest, single cycle — clean-insert read on the \'maybe a hint of toast\' question (temperature vs. residue)',
    accent=None,
    slug='papzp22',
    info=[
