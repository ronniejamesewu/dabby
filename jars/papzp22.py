...
STATUS = StrainStatus(
    ...
    slug='papzp22',
    info=[
        ('Strains', 'Papaya (clone-only, lineage unknown) + Z Pie #22 (Z × Georgia Pie — Georgia Pie: Gelatti × Kush Mints #11, see terpene note)'),
