...
STATUS = StrainStatus(
    ...
    next_text='Run 10: rerun the grey 450°F descent (450→450@10s→425@30s→410@45s) as a first-dab, modest, single cycle — read toast and swab together (toast + pooled spot leans airflow pocket; toast + uniform swab leans temperature; neither, the \'maybe\' was noise)',
    accent=None,
    slug='papzp22',
    info=[
